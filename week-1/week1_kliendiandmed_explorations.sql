...
-- Tallinna kliendid, sorteeritud nime järgi (SELECT taga puudus tärn ning ei andnud tulemust. Lisasin omavoliliselt eesnime sorteerimise ka, sest muidu on mõttetu sorteerimine ainult Aas järgi)
SELECT *
FROM customers
WHERE city = 'Tallinn'
